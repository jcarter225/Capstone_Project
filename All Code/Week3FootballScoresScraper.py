...
Script to scrape NCAA Football Scores of Week 3

This script is designed to get the final scores and the teams
that played in week 3 of 2022.
"""
...
Outcomes_response = requests.get('https://www.cbssports.com/college-football/scoreboard/FBS/2022/regular/3/', 'html.parser')
...
#make csv file
Outcomes_df.to_csv("Week3GameOutcomes.csv")
