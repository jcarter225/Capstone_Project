"""
Justin Carter
Script to scrape NCAA Football Scores of Week 17

This script is designed to get the final scores and the teams
that played in week 17 of 2022. It should be noted that Week 16 did not 
feature any games. As such, this week is the first week of games after week 16.
This week also sees the beginning of bowl season.
...
Outcomes_response = requests.get('https://www.cbssports.com/college-football/scoreboard/FBS/2022/postseason/17/', 'html.parser')
...
for sublist in Outcomes_total_scores_element_list:
    if sublist[-1]=="T" or sublist[-1] =="More College Football News" or sublist[-1]== '':
        continue
    else:
...
#make csv file
Outcomes_df.to_csv("Week17GameOutcomes.csv")
