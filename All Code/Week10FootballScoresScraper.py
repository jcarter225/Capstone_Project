"""
Justin Carter
Script to scrape NCAA Football Scores of Week 10

This script is designed to get the final scores and the teams
that played in week 10 of 2022.
...
Outcomes_response = requests.get('https://www.cbssports.com/college-football/scoreboard/FBS/2022/regular/10/', 'html.parser')
...
#make csv file
Outcomes_df.to_csv("Week10GameOutcomes.csv")
