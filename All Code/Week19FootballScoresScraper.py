"""
Justin Carter
Script to scrape NCAA Football Scores of Week 19

This script is designed to get the final scores and the teams
that played in week 19 of 2022. (This is the week that the championship
game was played)
...
Outcomes_response = requests.get('https://www.cbssports.com/college-football/scoreboard/FBS/2022/postseason/19/', 'html.parser')
...
#make csv file
Outcomes_df.to_csv("Week19GameOutcomes.csv")
