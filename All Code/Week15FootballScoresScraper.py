...
Script to scrape NCAA Football Scores of Week 15

This script is designed to get the final scores and the teams
that played in week 15 of 2022. It should be noted that this week only comprised
of one game: Navy at Army. 
...
Outcomes_response = requests.get('https://www.cbssports.com/college-football/scoreboard/FBS/2022/regular/15/', 'html.parser')
...
#make csv file
Outcomes_df.to_csv("Week15GameOutcomes.csv")
